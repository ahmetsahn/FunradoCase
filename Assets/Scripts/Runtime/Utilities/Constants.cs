namespace Runtime.Utilities
{
    public static class Constants 
    {
        ...
        public const float GRAPE_COLLECT_DELAY = 0.14f;
        public const float EXTRA_DELAY_FOR_NON_COLLECTABLES = 0.28f;
        public const float DELAY_INCREMENT_PER_GRAPE = 0.29f;
